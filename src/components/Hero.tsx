...
const Hero = () => {
    return (
        <div className='bg-center lg:bg-cover bg-hero bg-no-repeat md:min-h-screen 2xl:min-h-fit relative pb-20' style={{ backgroundImage: `url(/assets/images/webp/hero-bg.webp)` }}>
            <Header />
