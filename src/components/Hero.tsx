...
const Hero = () => {
    return (
        <div id='home' className='bg-center lg:bg-cover bg-hero bg-no-repeat md:min-h-screen 2xl:min-h-fit relative pb-20' style={{ backgroundImage: `url(/assets/images/webp/hero-bg.webp)` }}>
            <Header />
            <div className="container max-w-[1140px] mx-auto">
                <img className='lg:max-w-[404px] md:max-w-[388px] max-w-[256px] mx-auto md:pt-[170px] pt-[175px]' src="./assets/images/webp/logo-tag.webp" alt="hero-image" />
                ...
                <CustomButton text="Get Started" myClass=" md:!px-[33px] md:!py-[14px] !py-2 !px-[14.5px] !flex !mx-auto md:mt-11 max-sm:!mb-[85px] mt-[82px] hover:!scale-105" />
            </div>
